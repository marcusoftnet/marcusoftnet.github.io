---
layout: post
title: "AI flow - are we elevated? Or deskilled?"
...
Anyways, we have become the tender or guardian of [throughput](https://www.marcusoft.net/2026/07/ai-flow-throughput.html) rather than the producer of the throughput. This also means that we stand a risk of becoming the [constraint or bottleneck of the flow of value](https://www.marcusoft.net/2026/07/ai-flow-toc.html). Make no mistake - the agent can produce much more than any human can specify, review or validate.
...
This is the reason we do A/B tests and also the reason we want the flow to be fast; to quickly validate our assumption for real, rather than by gut feeling and hunches. [Read about the first time I tried A/B testing and the total disregard of the result here](https://www.marcusoft.net/2014/01/repost-do-we-dare-to-be-data-driven.html)
...
But in factories, it has historically been [*deskilling*](https://en.wikipedia.org/wiki/Labor_and_Monopoly_Capital) dressed up as elevation;

- lost craft - the welder is now inspecting weldings, but rarely do them
- lost autonomy - your job could become to [feed the machine](https://www.youtube.com/watch?v=6n9ESFJTnHs)
- slave to the numbers - [early management methods](https://en.wikipedia.org/wiki/Scientific_management) optimized the steps in the chain and you were held accountable to the numbers
...
There are some signals that this is already happening, with [AI agents burning developers out](https://evilmartians.com/chronicles/ai-assisted-engineers-are-burning-out-is-this-fine) faster, we [become AI zombies](https://www.youtube.com/watch?v=9UDLl9Q0azA) and [worries about not using tokens properly](https://writing.nikunjk.com/p/token-anxiety).
