...
> Yes that is “scaled” (whatever that is) #agile working and helpful, without any specific framework or tool. Just guided by #principles towards ever better versions of our practices. Thinking for yourself - it’s a good train. Get on it!
...
A really good thought experiment, although a little provocative, that we have used to illustrate this is: let's say that a team has 12 value deliverables line up for delivering the next couple of months. They are all good and well-described as how the support the effect.
...
But obviously they cannot know everything - so we have a group where they meet to get external input. It can range from Enterprise Architecture to prioritization to hiring new people. The best way to get access to the decision making in the team is to ... meet with the team. At their meeting. Fancy that.

### Why

We need cross-cutting concerns. I've talked about this before but just to hammer it home.

With autonomous teams, we can change direction faster and get a deeper understanding of our domain. But that means that we need to work together on certain topics. This is how we do that.

We do not want to slow down the teams. We want them to go fast. This is how we can go fast together.

## Summary

I'm sure that I missed a couple of principles here but these are the ones that are most relevant right now.

- **Visualization and transparency** - to get a better understanding of what we are doing
- **Continuous feedback and improvements** - to use what we understand for continuous improvements
- **Autonomous teams** - to create fast-moving, decision-making, learning organisms
- **Focus on value** - to make sure that we are here for a reason
- **Foster a psychologically safe environment** - to make sure that everyone can do their best
- **Cross-cutting concerns** - to make sure that we are working together when we need to

All these are based on agile principles. But you could also think of them as common sense. Or the right thing to do. Or things that we should strive towards anyway.

So please don't copy our practices. But take the principles we have tried to illustrate and see if they are relevant to your context. And if they are - how can you apply them in your situation?
