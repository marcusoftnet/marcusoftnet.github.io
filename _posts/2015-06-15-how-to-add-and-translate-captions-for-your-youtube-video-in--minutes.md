...
<img src="/img/youtubeSubtitlesMenu.png" style="float:left" width="50%">
...
<img src="/img/youtubeTranscriptWizard.png" style="float:right" width="50%">
...
1. Click the "English (automatic)" subtitle track
1. Unfold the "Actions"-menu and select "Unpublish"
1. Optionally delete the automatic track. Click the "Actions"-menu again and select "Delete subtitles".
...
The subtitles you created <a href="#subtitles">above</a> needs to be published too.

<img src="/img/youtubePublishButton.png" style="float:left" width="50%">

1. Wait until the set timings are completed (i.e. "Setting timings" doesn't show in the list of the subtitle tracks)
1. Click the subtitle track (called "English" in my case)
1. Scroll down to the bottom of the page and click the "Publish button". That's also a bit unintuitive I think. It's NOT in the Actions-menu.

<img src="/img/youtubeCaptionsButton.png" style="float:right" width="50%">
...
It works surprisingly well, especially when you original subtitle track is a of good quality, like ours.
...
1. Click to the "Subtitles and CC" menu option in the [Creator Studio](https://www.youtube.com/dashboard?o=U)
1. Click the current subtitle track ("English" in my case)
1. Click the "Actions"-menu and select a file format under "Download". I went with ".sbv", which I have absolutely no idea if it's good or bad. Worked for me.
1. Save the file under a suitable name
...
1. Scroll to the bottom of the screen and Select all of the translated text and copy that.
1. Now open a text editor and paste the translated text into a new file
1. Save the file as "IndonesianSubtitles.sbv"
...
1. Click to the "Subtitles and CC" menu option in the [Creator Studio](https://www.youtube.com/dashboard?o=U)
1. Click "Add new Subtitle or CC"
1. Select the language of the subtitle track. In my case "Indonesian"
1. Select "Upload a file"
1. Select the file you created above ("IndonesianSubtitles.sbv" for example)
1. Click "Upload"
