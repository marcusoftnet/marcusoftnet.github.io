...
Oh, this exercise is a very simple form of [Value Stream Mapping](http://en.wikipedia.org/wiki/Value_stream_mapping). You can do much more advanced versions of this, but it's seldom necessary to get the point across.
...
I think it's because we're all too often focusing on keeping people busy and efficient. Don't miss [Dan North](http://dannorth.net/) in this [excellent talk on effectiveness vs efficiency](http://vimeo.com/7849591).
...
> ["Working Software" is software that users are actually using. Until it’s in use it is truly useless.](http://zuill.us/WoodyZuill/2012/09/16/the-8-agile-maxims-of-woody-zuill/)

When I first introduced a colleague to [Mob Programming](http://codebetter.com/marcushammarberg/2013/08/06/mob-programming/) (quite simply: a whole team, one room, one computer, one keyboard, one screen - working on one thing at a time), his response was correctly:
...
[Google](https://www.google.com/search?q=prioritize+definition&oq=prioritize&aqs=chrome.2.69i57j0l5.6599j0j7&sourceid=chrome&espv=210&es_sm=122&ie=UTF-8#q=prioritize+definition) defines "prioritize" as:
...
>
> —[David P. Joyce](http://leanandkanban.wordpress.com/)
