...
![](/img/before%2520navigation%2520step%2520definition_thumb.jpg)

And I tweaked it to be reusable into this:

![](/img/cleaned%2520kanbancontroller%2520steps_thumb.jpg)

... which is a lot more code. It still works (just ran my specs) and it
makes my next step very easy. Here it is:

[](/img/step%2520definition%2520without%2520any%2520create%2520action%2520method_thumb%255B1%255D.jpg)
...
![](/img/using%2520create%2520instance_thumb.jpg)
...
![](/img/viewmodel%2520filled%2520in_thumb.jpg)
...
![](/img/submitting%2520a%2520filled%2520out%2520viewmodel_thumb.jpg)
...
![](/img/first%2520create%2520post%2520action%2520method_thumb.jpg)
...
![](/img/updated%2520when-step_thumb.jpg)
...
![](/img/view%2520returned%2520from%2520action%2520method%2520create_thumb.jpg)
...
![](/img/redirection%2520step_thumb%255B1%255D.jpg)

And the with the action method updated to this:

![](/img/redirection%2520action%2520controller_thumb.jpg)
...
![](/img/test%2520for%2520GetBoardsForUser_thumb.jpg)

And here the implementation:

![](/img/GetBoardsForUser%2520implementation_thumb.jpg)

And actually – with this in place I can easily write a specification for
the MyBoards page:

![](/img/scenario%2520for%2520navigating%2520my%2520boards_thumb%255B1%255D.jpg)
...
- I could actually put the services I need in the ScenarioContext.Current when needed (or lazy loading if you like). That shapes up the code a lot, look at the new    CreateController-method:
    ...
    ![](/img/CreateController%2520with%2520lazy%2520loaded%2520services_thumb.jpg)

And with all that in place I just needed the following two steps:

![](/img/Screen%2520shot%25202011-02-05%2520at%252012.18.03_thumb.jpg)
...
![](/img/create%2520sceanario%2520updated%2520and%2520concise_thumb.jpg)
...
![](/img/Screen%2520shot%25202011-02-05%2520at%252017.24.11_thumb.jpg)
...
![](/img/Screen%2520shot%25202011-02-05%2520at%252019.40.36_thumb.jpg)

And here’s the implementation. (Yes I know that this is a bit messy from a CQRS perspective. I should have done the update with an event and then updated the database with a [denormalizer](http://blog.fossmo.net/post/The-denormalizer-in-CQRS.aspx), but I couldn’t without bring in a [CQRS framework](http://ncqrs.org/) [of sort](https://github.com/tyronegroves/SimpleCQRS) and I think this blog post is long enough :)):

![](/img/command%2520handler%2520implementation_thumb.jpg)

### Finally

And now, once again, I can turn back to the failing specification and wrap it up with this implementation:

![](/img/create%2520action%2520method%2520implementation_thumb.jpg)
...
![](/img/error%2520message%2520for%2520model%2520db%2520conflict_thumb.jpg)
...
![](/img/application_start_thumb.jpg)
