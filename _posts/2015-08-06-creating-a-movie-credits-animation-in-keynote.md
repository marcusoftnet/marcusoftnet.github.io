...
<img src="/img/keynotecredits2.png" style="align:center" width="50%">

Now click on "Add an effect" and select the "Move"-option.

<img src="/img/keynotecredits3.png" style="align:center" width="50%">

This will show you an little animation of the how the text will move. Grab hold of the text in the end position and move it into the new place. In our cases, since we want this to scroll by the entire screen, that means that we will have to move it way up above the slide. You might need to grab and move a couple of times.
...
Or in my case, I just wanted a comical (?) effect, which is the reason I choose a low number and got this effect:
<video width="400" height="320" controls>
