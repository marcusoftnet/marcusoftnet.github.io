...
What I am saying though, is that when you start to do agile at any scale beyond a single team, you will soon start see these mindset shifts. And they are important and will challenge the current way of thinking in the organization. To the point where many times (own experiences only here) the old ways are harder to change, than the urge to "become agile".
