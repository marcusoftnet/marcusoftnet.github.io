...
This reference must now be updated since we move the `test.js` into folder. Make it `var users = require('../userRoutes.js').users;` and `

var app = require('../app.js');` and you should be good.
