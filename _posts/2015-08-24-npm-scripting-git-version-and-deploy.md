...
4. Push my code to [Heroku](http://heroku.com) using the [heroku tool-belt](https://toolbelt.heroku.com/)
...
<blockquote>
Note that I don't require this to be installed globally on the users computer. Including these tools as a <code>devDependencies</code> will make sure that I can use them.
</blockquote>
...
Pssst - you can silence the output from <code>npm</code> with <code>npm t -s</code>.
...
The Heroku command is trivial, once the [Heroku Tool-belt](https://toolbelt.heroku.com/) is installed.
...
* [Blog post](http://www.jayway.com/2014/03/28/running-scripts-with-npm/) from Anders Janemyr @ JayWay
