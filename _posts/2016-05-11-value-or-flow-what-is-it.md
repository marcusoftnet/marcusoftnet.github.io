...
This post could be summaried as you summaries an argument among kids; and then he said, so I said, and then she went, and I'm like SAYWAAAY?! but also hmmmmm… and then I went back home and asked a few friends and then I said Aaaaaah! And then I learned something deeper of what I until that point only was my firm belief. 
...
This little verse is a good reminder to keep our sights aligned when implementing lean. Lean is not about waste elimination first, as it's often implemented. It's about gaining flow. But flow in itself is not valuable - value is. This is the reason we are here producing values to our customers. 
...
But now **Dr** Reinertsen and the little phrase I've fallen back to so many times proved me wrong. According to that *value* comes first - and it feels very hard to disagree. 

I contacted [Håkan Forss](https://twitter.com/hakanforss) who is one of the more well-read guys I know on lean things and presented my problem. He's answer was short and sweet, but still telling;
...
Ok - the key word here is *strategy*. It's a plan - we don't *know* that it will work the best. We believe that, but it's still just one strategy out of many. Lean's strategy is to focus firstly on flow and then on resource efficiency. 

Another would be the inversion; trying to focus on resource efficiency first. That might also work, but it's proven hard. One example of where this has been taken very far is plan ecnomics in the Soviet Union. You had one factory that made only left shoes and another one making right shoes. They were both optimized in their own right but getting things to match up proves a disaster. 

If you ever been caught in a web of process and byrocrazy around office support (setting up a new co work to work for example), you've also experienced the same. Each part is optimized, but getting things to flow is almost impossible. 

What Håkan meant with his comment was simply; starting by focusing on getting small things to flow faster has proven an easier way to come closer to nirvana. Over trying to produce bigger, full featured things firstly and then get that process to go faster and faster. 

## Summary

I was very happy that I ended up in this discussion and condurrum because now I had to ask Håkan and think it through one lap more. And thus I understood some more. 
