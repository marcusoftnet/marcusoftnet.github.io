...
Most people would say something robust. Like a block of steel. But that is not *anti*-fragile it's just neutral. Fragile things are hurt by being mistreated. Robust things don't care.
...
I wrote this post because I saw how some of these ideas made the accelerated career program tick.
...
And that leaves us with the secret recipe; immersive-ness.
