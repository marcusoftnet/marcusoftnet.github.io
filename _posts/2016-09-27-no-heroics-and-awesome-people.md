...
The same goes for trying to implement a fast paced, agile, flow oriented process in an organization that is built for resource utilizations. [It's simple not optimized for doing the thing that we want.](https://www.marcusoft.net/2016/04/what-are-you-optimized-for-then.html)
