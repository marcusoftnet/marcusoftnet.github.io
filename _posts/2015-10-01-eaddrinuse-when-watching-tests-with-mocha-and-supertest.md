...
You can pass a port number to the `app.listen()` method. If you don't a _ephemeral port_ will be used. Meaning it last for a very short time, for example during one request. Again read [this post](https://realguess.net/2015/03/29/supertest-listen-at-random-port/) for more.
