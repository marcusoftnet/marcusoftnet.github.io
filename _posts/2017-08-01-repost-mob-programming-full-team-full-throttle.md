...
![Mob Programming](./Repost_Mob programming – full team, full throttle_files/MobProgramming_A_Rich_Tradition.png)

From [<span>http</span><span>://</span><span>mobprogramming</span><span>.</span><span>org</span><span>/</span>](http://mobprogramming.org/) (c) Andrea Zuill
...
Finally I’ve seen mob programming in action, tried it a couple of times and _knows_ that it works. One of those episodes was at my current client. One team had started to work on a major change in the domain model. I’m talking real foundational stuff – like introducing the concept of a Product into a domain that was really around products but didn’t have that concept in place today. That kind of changes thats referred to as “heart surgery”.
