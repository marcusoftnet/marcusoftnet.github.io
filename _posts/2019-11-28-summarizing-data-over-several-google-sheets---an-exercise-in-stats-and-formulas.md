...
![Individual Compared vs. Class](/img/IndividualComparedvsClass.png)

![Individual Compared vs. All Classes](/img/IndividualComparedvsAllClasses.png)
...
Each test (aka data point) in the course has it's own sheet and I then aggregate all of this data into on sheet with all the data points on. I've noticed that this is a good practice; keep the raw data on a separate sheet and then do aggregations separately.
...
![Data Points Structured](/img/DataPointsStructured.png)
...
![Individual Compared to Class (Old)](/img/IndividuaComparedToClassOld.png)
...
![Individual Compared to All Classes](/img/IndividualComparedvsAllClasses.png)
...
![Data Points Aggregated](/img/DataPointsAggregated.png)
