...
| Kanban in Action - a kanban introduction                     | This is an inspirational and educational presentation on <br />how kanban can help you and your team to be even better | 1-2 hours |
| Kanban in Action - improve my kanban board                   | In this talk we examine numerous ways that your board can be changed and improved to help you and improve your work | 1-2 hours |
| Kanban in Action - process improvements now! And forever!    | This is a workshop where we not only learn the basics of kanban and lean but also start to build out a board that we can start using tomorrow and then forever more | 3 hours   |
| Kanban in Action - upstream work                             | In this workshop we examine the earlier phases of development and see how lean priniciples and kanban can help us to improve flow. | 2-3 hours |
